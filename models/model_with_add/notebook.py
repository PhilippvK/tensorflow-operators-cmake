...
class TestModel(tf.Module):
  ...
  def add(self, x, y):
    ...
    return {'result' : tf.add(x, y)}

SAVED_MODEL_PATH = 'out/saved_models/test_variable'
TFLITE_FILE_PATH = 'out/model_with_add.tflite'
...
converter = tf.lite.TFLiteConverter.from_concrete_functions([module.add.get_concrete_function()])

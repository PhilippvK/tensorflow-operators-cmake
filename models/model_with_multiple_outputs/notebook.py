...
TFLITE_FILE_PATH = 'out/model_with_multiple_outputs.tflite'
...
converter = tf.lite.TFLiteConverter.from_concrete_functions([module.add_multi_out.get_concrete_function()])
